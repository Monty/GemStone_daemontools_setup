...
You can load Seaside 3.0 into GemStone by using the seaside_setup30 script, using
your own customized script, or loading Seaside interactively.

There are some utility scripts not run by setupAll.sh that can be useful when testing.
Even though they prompt you before executing, you should read them and understand what
they do before using them -- particularly destroy_seaside and destroy_setup
